...
def main():
    ...
    for i, data in enumerate(tqdm(data_loader)):
        with torch.no_grad():
            ...
            cur_img_path = f'{args.result_root}/{img_name}'
            save_tensor_img(cur_img_path, resulti[0].cpu())
    ...
    #     #cur_img_path = f'{args.result_root}/attack_{i}.png'
    #     cur_img_path = f'{args.result_root}/{img_path[i]}'
    #     save_tensor_img(cur_img_path, img[0].cpu())
    #     attacked_path.append(cur_img_path)
