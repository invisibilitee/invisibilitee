# draw_pattern
# python draw_infer_imgs2.py --result_root result_faster_rand_p200 \
#     --config configs/ssd/ssd300_fashion.py \
#     --pre_train checkpoints/ssd300_coco_20200307-a92d2092.pth \
#     --limit 50
import numpy as np
...
def main():
    ...
    original  = []
    # for i, imgname in enumerate(tqdm(data_loader)):
    #     imgpa = f'{args.result_root}/original_{i}.png'
    #     original.append(imgpa)
    #     if i >= args.limit:
    #         break
