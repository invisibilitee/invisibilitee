...
class CornerHead(BaseDenseHead):
    ...
    def _get_bboxes_single(self,
        ...
        if rescale:
            #print('type(batch_bboxes)', type(batch_bboxes))
            #print('type(img_meta[\'scale_factor\'])', type(img_meta['scale_factor']))
            batch_bboxes /= torch.from_numpy(img_meta['scale_factor']).cuda() #yaxian
