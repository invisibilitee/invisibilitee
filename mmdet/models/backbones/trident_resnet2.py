...
from mmdet.models.backbones.resnet2 import Bottleneck, ResNet2
...
class TridentResNet2(ResNet2):
    ...
    def __init__(self, depth, num_branch, test_branch_idx, trident_dilations, 
        ...
        super(TridentResNet2, self).__init__(depth, **kwargs)
        ...
        # add patch
        self.patch = get_patch_tensor(self.patch_path, training=self.training)
        ###########################
