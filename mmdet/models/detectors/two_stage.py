...
class TwoStageDetector(BaseDetector):
    ...
    def extract_feat(self, img, gt_keypoints=None): #yaxian
    ...
    def forward_test(self, img, img_metas, gt_keypoints=None, proposals=None, rescale=False):
        # yaxian add keypoints here, new function
