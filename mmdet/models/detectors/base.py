...
class BaseDetector(nn.Module, metaclass=ABCMeta):
    ...
    def forward_test(self, imgs, img_metas, gt_keypoints=None, **kwargs):
        """
        Args:
        ...
        if num_augs == 1:
            ...
            #print('gt_keypoints', gt_keypoints)
            return self.simple_test(imgs[0], img_metas[0], gt_keypoints=gt_keypoints, **kwargs)
        else:
            ...
            return self.aug_test(imgs, img_metas, gt_keypoints=gt_keypoints,  **kwargs)
    ...
    def forward(self, img, img_metas, return_loss=True, **kwargs):
        ...
        """
        # yaxian, forward is here
        # print('--------------BaseDetector forward-----------------')
        # print(img_metas[0])
        # print('img_metas: ',img_metas)
        '''
        {'filename': '/DATASETS_2/DeepFashion2/train/image/132163.jpg', 'ori_filename': '132163.jpg', 'ori_shape': (750, 750, 3), 'img_shape': (416, 416, 3), 'pad_shape': (416, 416, 3), 'scale_factor': array([0.6520376, 0.5388601, 0.6520376, 0.5388601], dtype=float32), 'flip': False, 'flip_direction': None, 'img_norm_cfg': {'mean': array([0., 0., 0.], dtype=float32), 'std': array([255., 255., 255.], dtype=float32), 'to_rgb': True}}
    ...
    def forward_show(self, imgs, img_metas, gt_keypoints):
        """
        yaxian
        Args:
        ...
        Returns:
            attacked image: A tensor of image.
        """
        ...
        x = self.backbone.attacked_image(imgs, gt_keypoints)
        return x