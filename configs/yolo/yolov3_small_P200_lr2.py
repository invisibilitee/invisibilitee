...
patch_size=200
patch_ori_size=400
patch_saved_path = '/home/yaxian_li/expriment/mmdetection-yax/patch_imgs_200_lr/yolov3_p200.png'
patch_init_path = '/home/yaxian_li/expriment/mmdetection-yax/patch_imgs_416_lr/yolov3_small_p_79600.png'
model = dict(
    type='YOLOV3',
    ...
    bbox_head=dict(
        ...
        loss_wh=dict(type='MSELoss', 
            loss_weight=10.0, reduction='sum', negative=True),
