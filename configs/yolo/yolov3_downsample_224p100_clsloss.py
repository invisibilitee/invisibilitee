...
# 训练时 中间patch存储目录
patch_saved_path = '/home/yaxian_li/expriment/mmdetection-yax/patch_downsample_224p100/p.png'
...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_tv=dict(type='TVLoss', loss_weight=0.001),
        loss_nps=dict(type='NPSLoss',patch_size=patch_ori_size, loss_weight=0.1)))
