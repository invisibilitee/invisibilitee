...
# attack settings
# model settings
patch_saved_path = '/home/yaxian_li/expriment/mmdetection-yax/patch_imgs/yolo_pattern.png'
...
model = dict(
    ...
    backbone=dict(type='Darknet3', depth=53, out_indices=(3, 4, 5),
        ...
        patch_init_path=patch_init_path, #mingyu
    ...
    neck=dict(
        ...
        out_channels=[512, 256, 416]),
    bbox_head=dict(
        type='YOLOV3Head',
        num_classes=80, #change according to the dataset
        in_channels=[512, 256, 416],
